...
using OnlineRestaurant.OwnerDAO.DAO.Impl;
using OnlineRestaurant.Services.Service;
using OnlineRestaurant.Services.Service.Impl;
...
namespace OnlineRestaurant.OwnerApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Swashbuckle.AspNetCore.Swagger.Info { Title = "OnlineRestaurant.OwnerApi", Version = "v1" });
            });
        }
